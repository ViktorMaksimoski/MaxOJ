...
export const Info = ({ children }: {children: React.ReactNode}) => {
  return (
    <div className="hidden sm:flex cursor-pointer bg-blue-800 border-2 border-sky-400 w-[85%] mx-auto
    px-8 py-3 mt-6 gap-6 items-center rounded-lg shadow-md shadow-blue-900/40">
